...
//软件专题列表的存放路径
$cfg_special_soft = $cfg_cmspath.'/special-soft';
$cfg_specialsofturl = $cfg_mainsite.$cfg_special;
...
//用户投稿图片存放目录
$cfg_user_dir = $cfg_medias_dir.'/php/upload/image/userup';
...
$cfg_softname = '极客视界管理系统';
$cfg_soft_enname = 'CMS';
$cfg_soft_devteam = 'CMS团队';
