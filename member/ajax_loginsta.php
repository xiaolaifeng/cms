...
?>
<div style="margin-top: 8px; float: right; width: 100px;">

	<div style="height: 36px; float: right;">
		<div class="user-account-info active" style="float: right; margin-top: 3px; ">
			  <span style="float: left;">
				<a class="login-user-profile login-user-name">
				<img width="30" height="30" src="<?php echo $facepic;?>" alt="<?php echo $cfg_ml->M_UserName; ?>"></a></span> 
		</div>
