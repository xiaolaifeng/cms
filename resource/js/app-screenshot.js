(function(a) {
    a.fn.appScreenshot = function(b) {
        ...
        return this.each(function() {
            var k = a(this);
            var l = k.find(".app-ss-ul");
            var h = l.find(">li");
            var j = k.find(".app-ss-menu");
            var r = j.find(">li");
            var z = k.find(".app-ss-prev");
            var B = k.find(".app-ss-next");
            var p = h.length;
            var y = 5;
            var s = "next";
            var f;
