...
class ListView
{
    ...
    function GetPageListST($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<li><a href='".str_replace("{page}",$prepagenum,$tnamerule)."' class='last-one'>上一页</a></li>\r\n";
            $indexpage="<li><a href='".str_replace("{page}",1,$tnamerule)."' class='first-page'>回到首页</a></li>\r\n";
        }
        else
        {
            $indexpage="<li  class='first-page'>回到首页</li>\r\n";
        }

        //下一页,未页的链接
        if($this->PageNo!=$totalpage && $totalpage>1)
        {
            $nextpage.="<li><a href='".str_replace("{page}",$nextpagenum,$tnamerule)."'  class='next-one'>下一页</a></li>\r\n";
...
//        if(preg_match('/info/i', $listitem)) $plist .= $maininfo;
    ...
    function GetPageListDM($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($this->PageNo != 1)
        {
            ...
            $indexpage="<li><a href='".$purl."PageNo=1'>回到首页</a></li>\r\n";
        }
        else
        {
            $indexpage="<li><a>回到首页</a></li>\r\n";
        }
        if($this->PageNo!=$totalpage && $totalpage>1)
        {
