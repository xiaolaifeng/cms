...
else if($dopost=='save')
{
    ...
    $app_version  = trim(cn_substrR($app_version, 40));
    $userip = GetIP();
    ...
    $useip = GetIP();
    $inQuery = "INSERT INTO `$addtable`(aid,app_version,typeid,redirecturl,userip,filetype,language,softtype,accredit,
    os,softrank,officialUrl,officialDemo,softsize,softlinks,introduce,daccess,needmoney{$inadd_f})
    VALUES ('$arcID','$app_version','$typeid','$redirecturl','$useip','$filetype','$language','$softtype','$accredit',
