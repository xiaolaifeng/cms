...
//            return "<span class=\"pageinfo\">共0页/".$this->TotalResult."条</span>";
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<li><a  class='last-one'  href='".$purl."/$prepagenum/'>上一页</a></li>\r\n";
            $indexpage="<li><a class='first-page' href='".$purl."/1/'>回到首页</a></li>\r\n";
        }
        else
        {
            $indexpage="<li><a class='first-page' >回到首页</a></li>\r\n";
        }
        if($this->PageNo!=$totalpage && $totalpage>1)
        {
            $nextpage.="<li><a class='next-one'  href='".$purl."/$nextpagenum/'>下一页</a></li>\r\n";
